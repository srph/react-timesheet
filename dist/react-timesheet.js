(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactTimesheet"] = factory(require("React"), require("ReactDOM"));
	else
		root["ReactTimesheet"] = factory(root["React"], root["ReactDOM"]);
...
var height = exports.height = 125;
var width = exports.width = 250;
var scaled = exports.scaled = 48;
...
var _propertyUtils = __webpack_require__(185);
...
var _reactInputAutosize = __webpack_require__(215);
...
var _utilsDefaultArrowRenderer = __webpack_require__(223);

var _utilsDefaultArrowRenderer2 = _interopRequireDefault(_utilsDefaultArrowRenderer);

var _utilsDefaultFilterOptions = __webpack_require__(134);

var _utilsDefaultFilterOptions2 = _interopRequireDefault(_utilsDefaultFilterOptions);

var _utilsDefaultMenuRenderer = __webpack_require__(135);

var _utilsDefaultMenuRenderer2 = _interopRequireDefault(_utilsDefaultMenuRenderer);

var _utilsDefaultClearRenderer = __webpack_require__(224);
...
exports.default = getIncrementDifference;
 ...
 * @return {float}
 */
function getIncrementDifference(start, end, increment) {
  increment = _moment2.default.duration(increment).asHours();
  var difference = _moment2.default.duration(end.diff(start)).asHours();
...
var _clamp = __webpack_require__(192);
...
var _getIncrementDifference = __webpack_require__(7);

var _getIncrementDifference2 = _interopRequireDefault(_getIncrementDifference);
...
var DraggableLayer = function (_Component) {
  _inherits(DraggableLayer, _Component);
  ...
  function DraggableLayer() {
    ...
    _classCallCheck(this, DraggableLayer);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DraggableLayer.__proto__ || Object.getPrototypeOf(DraggableLayer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      x: 0,
      y: 0,
      dragging: 0
    }, _this.handleDragStart = function (evt, position) {
      ...
      var time = times.findIndex(function (time) {
        return time.start.isSame(schedule.start);
      });
      var day = Object.keys(schedules).indexOf(source.day);

      var scaled = _this.props.scaled;
    ...
    }, _this.handleDrag = function (evt, position) {
      _this.setState({
        x: _this.state.x + position.deltaX,
        y: _this.state.y + position.deltaY,
        dragging: true
      });
    }, _this.handleDragStop = function (evt) {
      ...
      var _this$props2 = _this.props,
          ...
          schedules = _this$props2.schedules,
          times = _this$props2.times;

      var keys = Object.keys(schedules);
      var day = keys[(0, _clamp2.default)(Math.ceil(x / width), 0, keys.length - 1)]; // Target day (index)
      var time = times[(0, _clamp2.default)(Math.ceil(y / height), 0, times.length - 1)]; // Target time (index)
      ...
      if (!time.start.isSame(schedule.start)) {
        var increment = _this.props.time.increment;

        var difference = (0, _getIncrementDifference2.default)(start, end, increment);
        start = time.start.clone();
        var hours = difference * increment.hours;
        var minutes = difference * increment.minutes;
      ...
      if (_this.props.validate({ day: day, schedule: schedule, start: start, end: end })) {
        var updated = _extends({}, schedule, {
          start: start,
          end: end
        });
        ...
        _this.props.onDrag(source.day, source.index, updated, day);
      }
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(DraggableLayer, [{
    key: 'render',
    value: function render() {
      var scaled = this.props.scaled;
...
exports.default = DraggableLayer;
...
var _reactClickOutside = __webpack_require__(132);
...
var HoverCard = function (_Component) {
  _inherits(HoverCard, _Component);

  function HoverCard() {
    _classCallCheck(this, HoverCard);

    return _possibleConstructorReturn(this, (HoverCard.__proto__ || Object.getPrototypeOf(HoverCard)).apply(this, arguments));
  }
  ...
  _createClass(HoverCard, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'timesheet__popover-body' },
          (schedule.request || current || done) && _react2.default.createElement(
            'div',
...
var Popover = function (_Component) {
  ...
  function Popover() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Popover.__proto__ || Object.getPrototypeOf(Popover)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      professor: _this.props.schedule.data.professor,
      subject: _this.props.schedule.data.subject,
      section: _this.props.schedule.data.section
    }, _this.handleEscape = function (evt) {
      if (evt.keyCode === 27) {
        _this.props.onCancel();
      }
    }, _this.handleInput = function (field) {
      return function (option) {
        option = option || { label: '', value: '' };

        _this.setState(_defineProperty({}, field, _extends({}, _this.state[field], {
          id: option.value,
          name: option.label
        })));
      };
  ...
  _createClass(Popover, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          recent = _props.recent,
          schedules = _props.schedules,
          source = _props.source,
          scaled = _props.scaled;


      var height = scaled ? _settings2.default.scaled : _settings2.default.height;
      var width = scaled ? _settings2.default.scaled : _settings2.default.width;

      var top = height * source.time + (scaled ? -45 : 30);
      var left = width * (Object.keys(schedules).findIndex(function (day) {
        return source.day === day;
      }) + 1) + (scaled ? 85 : 150);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'u-spacer' },
              _react2.default.createElement(_reactSelect2.default, { autofocus: true,
          ...
          _react2.default.createElement(
            'footer',
            { className: 'timesheet__popover-footer' },
            _react2.default.createElement(
              'button',
...
var Resizer = function (_Component) {
  ...
  function Resizer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Resizer.__proto__ || Object.getPrototypeOf(Resizer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      resize: 0,
      resizing: false
      ...
      _this.setState({
        ...
        // (start - end) / increment
        resize: (0, _getIncrementDifference2.default)(start, end, time.increment)
      });
    }, _this.handleResize = function (evt, position) {
      var height = _this.props.scaled ? _settings2.default.scaled : _settings2.default.height;

      _this.setState({
        resize: _this.state.resize + position.deltaY / height,
        resizing: true
      });
      ...
      var increment = time.increment;

      var end = schedule.start.clone().add(resize * increment.hours, 'hours').add(resize * increment.minutes, 'minutes');

      if (_this.props.validate({ day: source.day, schedule: schedule, start: schedule.start, end: end })) {
        _this.props.onResize(source.day, source.index, _extends({}, schedule, {
          end: end
        }));
      }
  ...
  _createClass(Resizer, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('div', { className: 'timesheet__overlay-resizer draggable-cancel' })
      );
    }
  }]);
...
function times(start, end, step) {
  start = (0, _moment2.default)(start, 'hh:mm a');
  end = (0, _moment2.default)(end, 'hh:mm a');

  var results = [];
  var current = start;

  while (current < end) {
    var next = current.clone().add(step.hours, 'hours').add(step.minutes, 'minutes');
...
var getIn = __webpack_require__(216);
var updateIn = __webpack_require__(217);
...
var _componentClasses = __webpack_require__(176);
...
var _getAlignOffset = __webpack_require__(180);
...
var _getOffsetParent = __webpack_require__(19);
...
var _getVisibleRectForElement = __webpack_require__(183);

var _getVisibleRectForElement2 = _interopRequireDefault(_getVisibleRectForElement);

var _adjustForViewport = __webpack_require__(179);

var _adjustForViewport2 = _interopRequireDefault(_adjustForViewport);

var _getRegion = __webpack_require__(182);

var _getRegion2 = _interopRequireDefault(_getRegion);

var _getElFuturePos = __webpack_require__(181);
...
var baseClamp = __webpack_require__(186),
...
var _domAlign = __webpack_require__(184);
...
var _cssAnimation = __webpack_require__(178);
...
var _utilsStripDiacritics = __webpack_require__(136);
...
var _reactLinkState = __webpack_require__(143);
...
var _rcTooltip = __webpack_require__(142);

var _rcTooltip2 = _interopRequireDefault(_rcTooltip);

var _DraggableLayer = __webpack_require__(137);

var _DraggableLayer2 = _interopRequireDefault(_DraggableLayer);

var _Resizer = __webpack_require__(140);
...
var _HoverCard = __webpack_require__(138);

var _HoverCard2 = _interopRequireDefault(_HoverCard);
...
var Timesheet = function (_React$Component) {
  ...
  function Timesheet() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Timesheet.__proto__ || Object.getPrototypeOf(Timesheet)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      schedules: _this.props.schedules,
      times: (0, _generate2.default)(_this.props.time.start, _this.props.time.end, _this.props.time.increment),
      ...
      return dest.start < dest.end && dest.end <= last.end && !day.find(function (schedule) {
        return dest.schedule !== schedule &&
      ...
      if (_this.state.recent) {
        var _this$state2 = _this.state,
            schedules = _this$state2.schedules,
    ...
    }, _this.handleSubmit = function (schedule) {
      var _this$state$edit = _this.state.edit,
          day = _this$state$edit.day,
    ...
    }, _this.handleResize = function (day, index, schedule) {
      _this.props.onUpdate(day, index, schedule);
    }, _this.handleScale = function () {
      _this.setState({ scaled: !_this.state.scaled });
    }, _this.handleMouseEnter = function (day, index) {
      return function () {
        if (!_this.state.scaled || _this.state.recent) {
          return;
        }
        ...
        var schedule = schedules[day][index];
        // Index of the time in the array
        var time = times.findIndex(function (time) {
          return schedule.start.isSame(time.start);
        });

        _this.setState({
          hover: { day: day, index: index, time: time },
          hovering: true
        });
      };
  ...
  _createClass(Timesheet, [{
    ...
    value: function componentDidMount() {
      ...
      this.now = setInterval(function () {
        _this2.setState({ now: _this2.state.now.add(1, 'seconds') });
      }, 1000);
    }
  }, {
    key: 'componentWillUnmount',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { type: 'button', className: 'timesheet__scale', onClick: this.handleScale },
          'Scale ',
          scaled ? 'Up' : 'Down'
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'timesheet__heading-column timesheet__heading-column--narrow' },
            'Time'
          ),
          Object.keys(schedules).map(function (schedule, i) {
            return _react2.default.createElement(
              'div',
              { className: 'timesheet__heading-column', key: i },
              schedule
            );
          })
        ),
        _react2.default.createElement(
          'div',
          { className: 'timesheet__body' },
          _react2.default.createElement(
            'div',
            { className: 'timesheet__column timesheet__column--narrow' },
            times.map(function (time, i) {
              return _react2.default.createElement(
                'div',
                { className: 'timesheet__item', key: i },
                _react2.default.createElement(
                  'div',
                  { className: 'timesheet__time' },
                  time.start.format('hh:mm a'),
                  ' - ',
                  time.end.format('hh:mm a')
                )
              );
            })
          ),
          Object.keys(schedules).map(function (day, i) {
            return _react2.default.createElement(
              'div',
              { className: 'timesheet__column', key: i },
              times.map(function (time, ii) {
                return _react2.default.createElement('div', { className: 'timesheet__item',
                  onDoubleClick: _this3.handleCreate(day, ii),
                  key: ii });
              }),
              schedules[day].map(function (schedule, ii) {
                ...
                var content = _react2.default.createElement(
                  'div',
                  { onDoubleClick: _this3.handleEdit(day, ii),
                    onMouseEnter: _this3.handleMouseEnter(day, ii),
                    ...
                    style: {
                      transform: 'translateY(' + height * times.findIndex(function (time) {
                        return time.start.isSame(schedule.start);
                      }) + 'px)',
                      height: height * (0, _getIncrementDifference2.default)(schedule.start, schedule.end, _this3.props.time.increment)
                    },
                    key: ii },
                  _react2.default.createElement(
                    'div',
                    { className: 'timesheet__overlay-inner' },
                    !scaled && (schedule.request || current || done) && _react2.default.createElement(
                      'div',
                      { className: 'timesheet__overlay-status' },
                      schedule.request ? editing && schedules[edit.day][edit.index] === schedule ? 'Requested' : _react2.default.createElement(
                        _rcTooltip2.default,
                        { overlay: 'Requested by ' + schedule.requester.user.name + ' of Department ' + schedule.requester.department.name, placement: 'right' },
                        _react2.default.createElement(
                          'span',
                          null,
                          'Requested'
                    ...
                    !scaled && !editing && !_this3.props.request && schedule.request && _react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        _rcTooltip2.default,
                        { overlay: 'Accept', placement: 'right' },
                        _react2.default.createElement(
                          'span',
                          null,
                          '\u2714'
                    ...
                    !scaled && !editing && schedule.request && (!_this3.props.request || _this3.props.request && _this3.props.requester.id === schedule.requester.id) && _react2.default.createElement(
                      ...
                      { className: (0, _classnames2.default)('timesheet__overlay-action', {
                        ...
                        }), onClick: _this3.handleRequestAction(day, ii, false) },
                      _react2.default.createElement(
                        _rcTooltip2.default,
                        { overlay: _this3.props.request ? 'Cancel' : 'Decline', placement: 'right' },
                        _react2.default.createElement(
                          'span',
                          null,
                          '\u2715'
          ...
          !disabled && editing && _react2.default.createElement(_Popover2.default, {
            ...
            onSubmit: this.handleSubmit }),
          scaled && hovering && _react2.default.createElement(_HoverCard2.default, {
            ref: function ref(c) {
     ...
     */
    value: function handleCreate(day, index) {
      var _this4 = this;
      ...
      return function () {
        ...
        _this4.setState({
          schedules: _extends({}, schedules, _defineProperty({}, day, [].concat(_toConsumableArray(schedule), [{
            start: time.start,
            end: time.end,
            request: _this4.props.request,
            requester: _this4.props.requester,
            data: {
              subject: {
                id: 0,
                name: ''
          ...
          editing: true,
          edit: { day: day, index: schedule.length, time: index },
          recent: true
        });
      };
    }
    ...
    key: 'handleEdit',
    value: function handleEdit(day, index) {
      var _this5 = this;

      return function () {
        if (_this5.props.disabled) {
          return;
        }
        ...
        if (_this5.props.request && !schedule.request) {
          return;
        }

        if (schedule.request && _this5.props.requester.id !== schedule.requester.id) {
          return;
        }
        ...
        _this5.setState({
          editing: true,
          edit: { day: day, index: index, time: time },
          hovering: false,
          hover: null
        });
      };
...
Timesheet.propTypes = {
  time: _react.PropTypes.shape({
    ...
    increment: _react.PropTypes.shape({
      start: _react.PropTypes.number,
      end: _react.PropTypes.number
    }).isRequired
  }).isRequired,
  schedules: _react.PropTypes.object.isRequired,
  ...
  requester: _react.PropTypes.object,
  onRequestAction: _react.PropTypes.func
};
