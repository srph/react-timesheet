                ...
                const content = (
                  <div onDoubleClick={this.handleEdit(day, ii)}
                    ...
                    <div className="timesheet__overlay-inner">
                      ...
                      {!scaled && !this.props.request && schedule.request && !editing && <button className="timesheet__overlay-action" onClick={this.handleRequestAction(day, ii, true)}>
                        <Tooltip overlay="Accept" placement="right"><span>✔</span></Tooltip>
                      </button>}

                      {!scaled && schedule.request && !editing && <button className={c('timesheet__overlay-action', {
                        'timesheet__overlay-action--negative': !this.props.request
                      })} onClick={this.handleRequestAction(day, ii, false)}>
                        <Tooltip overlay="Decline" placement="right"><span>✕</span></Tooltip>
                      </button>}
