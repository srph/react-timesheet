  ...
  render() {
    ...
    return (
      <div className={c('timesheet', {
        ...
        <button type="button" className="timesheet__scale" onClick={this.handleScale}>
          Scale {scaled ? 'Up' : 'Down'}
        </button>
                ...
                const content = (
                  <div onDoubleClick={this.handleEdit(day, ii)}
                    ...
                    <div className="timesheet__overlay-inner">
                      ...
                      {!scaled && !editing && !this.props.request && schedule.request && this.props.requester.id === schedule.requester.id && <button className="timesheet__overlay-action" onClick={this.handleRequestAction(day, ii, true)}>
                        <Tooltip overlay="Accept" placement="right"><span>✔</span></Tooltip>
                      </button>}

                      {!scaled && !editing && schedule.request && this.props.requester.id === schedule.requester.id && <button className={c('timesheet__overlay-action', {
