...
class Timesheet extends React.Component {
  ...
  validate(dest) {
    ...
    return !!day.find((schedule) =>
      ...
      moment(dest.start, 'hh:mm a') < moment(schedule.start, 'hh:mm a') &&
      moment(dest.start, 'hh:mm a') > moment(schedule.end, 'hh:mm a') &&
      // Must end before and after end
      moment(dest.end, 'hh:mm a') < moment(schedule.start, 'hh:mm a') &&
      moment(dest.end, 'hh:mm a') > moment(schedule.end, 'hh:mm a'));
  }
